...
console.log(
  `Car Details: Year - ${car.year}, Make - ${car.make}, Model - ${car.model}`
);
...
console.log(
  `Car Interface Details: Year - ${carInterface.year}, Make - ${carInterface.make}, Model - ${carInterface.model}`
);
...
console.log(
  `Hybrid Car Details: Battery Capacity - ${carDetails.batteryCapacity} kWh, Fuel Type - ${carDetails.fuelType}, Range - ${carDetails.range} km, Charge Time - ${carDetails.chargeTime} hours`
);
